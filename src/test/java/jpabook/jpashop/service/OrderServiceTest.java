...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Member member = createMember("sskim");
        Item book = createItem("JPA BOOK", price, stockQuantity);
    ...
    public void 주문취소() throws Exception {
        ...
        //then
        Order order = orderRepository.findOne(orderId);
        assertEquals("상품 주문시 상태는 CANCEL", OrderStatus.CANCEL, order.getOrderStatus());
